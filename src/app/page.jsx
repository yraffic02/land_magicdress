...
export default function Home() {
  return (
      <main  className="flex flex-col items-center justify-center gap-4">
        ...
        <Link
          className="w-1/2"
          href='https://api.whatsapp.com/?phone=98986003440&text=Gostaria+de%20saber%20mais%20informa%C3%A7%C3%B5es%20sobre%20o%20aluguel%20de%20roupas!'
        >
          <AnimatedButton title="WhatsApp"/>
        </Link>
        <Link
          className="w-1/2"
          href='https://www.instagram.com/magicdress.br/'
        >
